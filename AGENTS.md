# AGENTS.md — Mosaic Rust Kernel & Model Layer

> **You are Codex, implementing the Rust kernel + model layer for Mosaic.**
>
...
- **Active / forward-looking docs use "Mosaic":** README, AGENTS.md (this file), HANDOFF.md, CURRENT_STATE.md, MASTER_PHASE_PLAN.md, strategy docs, process-notes, and any new for-dummies / handoff / completion-report / ADR going forward.
...
3. `AGENTS.md` (this file) — process and self-checks
...
This is a **AGENTS.md amendment to brief §15 step 6**, which reads
...
*End of `AGENTS.md`. If this file conflicts with anything in `docs/`, the

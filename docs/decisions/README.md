...
| [0033](./0033-phase-10a-evaluation-metrics-library.md) | Phase 10A — Evaluation Metrics Library | **Proposed** — first phase of the evaluation-primitives track (demand-driven, Option 3). Ships 5 new formula primitives (`std_over`, `var_over`, `count_over`, `wilson_ci_lower`, `wilson_ci_upper`) + metrics cookbook documenting compositional patterns for direction_accuracy, ROI, Brier, Sharpe, etc. Unblocks Phase 10B (grade), 10C (backtest), 10D (batch sweep) |

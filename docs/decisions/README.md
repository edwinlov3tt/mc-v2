...
| [0031](./0031-nbinom-sf-formula-function.md) | Phase 3L — `nbinom_sf()` Negative Binomial Survival Function | **Proposed with 7 acceptance amendments** — distributional formula primitive for MLB cartridge; hand-rolled (no stats dep); fixtures regenerated from scipy 1.13.1; invalid-domain returns Null (not error); shared cdf/sf helper; driven by claw-core EXP-028 |

...
**Last updated:** 2026-05-02 (Phase 2D shipped at `0678a98`, tagged `phase-2d-bitset-and-invalidated-fix`; closes PERF.md §9.3 and the §6.14 `load_canonical_inputs` cliff; acceptance gate beat by 47×)

...
| **3D** | Friendly formula syntax — `Revenue = Customers * AOV` strings compile to `ParsedRuleBody`'s structured tree (originally ADR-0004's Phase 3C; renamed to 3D per ADR-0006 roadmap impact) | **complete pending review** (report at [`../reports/phase-3d-completion-report.md`](../reports/phase-3d-completion-report.md); not yet committed/tagged per the handoff hard rule) | — |
...
### 3D — Friendly formula syntax (complete pending review)

- **Status:** **complete pending review** (2026-05-03; not yet committed/tagged per the handoff hard rule). Originally named "Phase 3C" in [ADR-0004 Decision 4](../decisions/0004-phase-3a-model-definition-format.md); renamed to Phase 3D per ADR-0006 roadmap impact.

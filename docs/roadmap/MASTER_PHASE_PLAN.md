...
| **8.1** | Service daemon full — all remaining verb endpoints (whatif/sweep/diff/narrate), MCP server, org mode, Tessera schedule integration (batch protocol), `mc ps`/`mc reload`, warm restart with content hashes. Per ADR-0029. | planned | — |
